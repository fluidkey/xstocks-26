...
- [x] 1. Scaffold Foundry project and shared infrastructure
  - [x] 1.1 Initialize Foundry project in `contract/`
  ...
  - [x] 1.2 Create `ISafe.sol` interface and mock ERC-4626 vault
...
- [x] 2. Implement VaultWrapperFactory
  - [x] 2.1 Create `contract/src/VaultWrapperFactory.sol`
  ...
  - [x] 2.2 Write property test: Factory Deploy Idempotence
  ...
  - [x] 2.3 Write property test: Factory CREATE2 Determinism
  ...
  - [x] 2.4 Write property test: Fee Percentage Validation
  ...
  - [x] 2.5 Write unit tests for VaultWrapperFactory
...
- [x] 3. Checkpoint — Factory tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement VaultWrapper core (ERC20, non-transferable, constructor)
  - [x] 4.1 Create `contract/src/VaultWrapper.sol` — ERC20 base and immutables
  ...
  - [x] 4.2 Write property test: Non-Transferable Shares
...
- [x] 5. Implement VaultWrapper fee math and view functions
  - [x] 5.1 Implement virtual fee share computation and view functions
  ...
  - [x] 5.2 Write property test: Virtual Fee Shares Formula
  ...
  - [x] 5.3 Write property test: Effective Total Supply Invariant
...
- [x] 6. Implement VaultWrapper deposit, withdraw, redeem
  - [x] 6.1 Implement `deposit(uint256 assets, address receiver, address feeCollector)` and `mint(uint256 shares, address receiver, address feeCollector)`
  ...
  - [x] 6.2 Implement `withdraw(uint256 assets, address receiver, address owner)` and `redeem(uint256 shares, address receiver, address owner)`
  ...
  - [x] 6.3 Write property test: Deposit Mints Correct Shares
  ...
  - [x] 6.4 Write property test: Settlement on Position Change
  ...
  - [x] 6.5 Write property test: Fee Collector Assignment and AUM Tracking
  ...
  - [x] 6.6 Write property test: Deposit-Withdraw Round Trip
...
- [x] 7. Implement VaultWrapper fee collection
  - [x] 7.1 Implement `collectFees(address feeCollector)`
  ...
  - [x] 7.2 Write property test: Fee Collection Transfers to Collector
  ...
  - [x] 7.3 Write property test: Fee Collection Preserves Real Total Supply
  ...
  - [x] 7.4 Write property test: Global Settled Virtual Shares Consistency
...
- [x] 8. Checkpoint — VaultWrapper tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Implement SafeEarnModule — lifecycle and relayer management
  - [x] 9.1 Create `contract/src/SafeEarnModule.sol` — constructor, storage, relayer management
  ...
  - [x] 9.2 Implement module lifecycle: `onInstall`, `onUninstall`, `changeMerkleRoot`, `isInitialized`
  ...
  - [x] 9.3 Write property test: Module onInstall Stores Config
  ...
  - [x] 9.6 Write property test: Relayer Management
    - **Property 18: Relayer Management**
    - Fuzz over random addresses; assert add/remove behavior and self-removal revert
    - **Validates: Requirements 9.8**

- [x] 10. Implement SafeEarnModule — signature verification and replay protection
  - [x] 10.1 Implement signature verification and replay protection helpers
  ...
  - [x] 10.2 Write property test: Signature Verification
  ...
  - [x] 10.3 Write property test: Replay Protection
    - **Property 17: Replay Protection**
    - Fuzz over valid signatures; assert second submission reverts with `SignatureAlreadyUsed`
    - **Validates: Requirements 9.5, 9.6**

- [x] 11. Implement SafeEarnModule — autoDeposit and autoWithdraw
  - [x] 11.1 Implement `autoDeposit`
  ...
  - [x] 11.3 Write property test: Merkle Proof Verification
  ...
  - [x] 11.4 Write property test: Merkle Leaf Uniqueness
    - **Property 22: Merkle Leaf Uniqueness**
    - Fuzz over two distinct (vault, fee) pairs; assert computed leaves differ
    - **Validates: Requirements 12.1, 12.3**

- [x] 12. Checkpoint — SafeEarnModule tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 13. Integration tests — end-to-end flows
  - [x] 13.1 Write property test: Deposit Flow Correctness
  ...
  - [x] 13.2 Write property test: Withdrawal Flow Correctness
  ...
  - [x] 13.3 Write integration unit tests
